...
void init_sysettings()
{
	...
	mtk_cmd_seq(appid,
		...
		"g_nfs0 = new Grid()",
		"l_nfs = new Label(-text \"NFS\" -font \"title\")",
		"s_nfs1 = new Separator(-vertical no)",
		"s_nfs2 = new Separator(-vertical no)",
		"g_nfs0.place(s_nfs1, -column 1 -row 1)",
		"g_nfs0.place(l_nfs, -column 2 -row 1)",
		"g_nfs0.place(s_nfs2, -column 3 -row 1)",
		"g_nfs1 = new Grid()",
		"l_nfs = new Label(-text \"NFS path:\")",
		"e_nfs = new Entry()",
		"g_nfs1.place(l_nfs, -column 1 -row 1)",
		"g_nfs1.place(e_nfs, -column 2 -row 1)",
		...
		"g.place(g_nfs0, -column 1 -row 5)",
		"g.place(g_nfs1, -column 1 -row 6)",
