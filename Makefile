...
# GUI
OBJS+=messagebox.o filedialog.o resmgr.o guirender.o cp.o audio.o dmxtable.o dmx.o patcheditor.o monitor.o firstpatch.o sysettings.o about.o flash.o shutdown.o
